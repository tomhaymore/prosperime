...
# from Prosperime
from careers.models import Career, IdealPosition, SavedCareer, Position, GoalPosition
...
class GoalPositionAdmin(admin.ModelAdmin):
	pass
...
admin.site.register(GoalPosition,GoalPositionAdmin)
