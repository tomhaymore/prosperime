...
urlpatterns = patterns('',
    ...
    url(r'^discover/career/(\d+)/orgs/$', 'entities.views.discover_career_orgs'),
    url(r'^discover/career/(\d+)/positions/$', 'entities.views.discover_career_positions'),
    ...
    url(r'^saved_paths/(.+)', 'careers.views.all_paths'),
