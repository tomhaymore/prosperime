...
urlpatterns = patterns('',
    ...
    url(r'^saved/','saved_paths.views.all_paths'),
    ...
    url(r'^saved_paths/save/(.+)/(\d+)/$','saved_paths.views.save_position'),
    url(r'^saved_paths/create/(.+)/(\d+)/$', 'saved_paths.views.create_path_add_position'),
    url(r'^saved_paths/create/(.+)/$', 'saved_paths.views.create_path'),
    url(r'^saved_paths/delete/(.+)/(\d+)/$', 'saved_paths.views.delete'),
    url(r'^saved_paths/(.+)/$', 'saved_paths.views.show_path'),
